      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(Icons.star_border, '중요문서함', () {}),
            _buildDrawerItem(Icons.delete, '휴지통', () {
              Navigator.push(
                scaffoldContext,
                MaterialPageRoute(builder: (context) => TrashScreen(username: username)),
              );
            }),
            _buildDrawerItem(Icons.check, '예약하기', () {
              Navigator.push(
                scaffoldContext,
                MaterialPageRoute(builder: (context) => FileReservationScreen()),
              );
            }),
            _buildDrawerItem(Icons.sd_storage, '저장용량', () {
            ...
            // ⭐ 추가된 로그아웃 버튼
            _buildDrawerItem(Icons.logout, '로그아웃', () {
              _logout(context);
            }),

            // ⭐ 추가된 회원탈퇴 버튼
            _buildDrawerItem(Icons.person_off, '회원탈퇴', () {
